...
class MyRadioList {
  ...
  factory MyRadioList.fromMap(Map<String, dynamic> map) {
    return MyRadioList(
        music: List<MyRadio>.from(
      (map['music']?.map((x) => MyRadio.fromMap(x))),
    ));
  }
  ...
  @override
  String toString() => 'MyRadioList(music: $music)';

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;

    return other is MyRadioList && listEquals(other.music, music);
  }
